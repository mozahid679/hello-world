...
All installation steps go here.
    •  Clone or download this Repositories (https://github.com/Eurosiamart-Rayple-IT-Development/Teknivers).
    •   If the file was downloaded, then unzip it and open it on a Code Editor.
    • 
## Development
